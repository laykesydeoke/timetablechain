export function validatequeuesysValue(val: number): { valid: boolean; error?: string } {
...
export function validatequeuesysId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatqueuesysValue(val: number): string {
