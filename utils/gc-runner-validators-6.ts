export function validategcrunnerValue(val: number): { valid: boolean; error?: string } {
...
export function validategcrunnerId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatgcrunnerValue(val: number): string {
