export function validatexssguardValue(val: number): { valid: boolean; error?: string } {
...
export function validatexssguardId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatxssguardValue(val: number): string {
