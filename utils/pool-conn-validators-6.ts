export function validatepoolconnValue(val: number): { valid: boolean; error?: string } {
...
export function validatepoolconnId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatpoolconnValue(val: number): string {
