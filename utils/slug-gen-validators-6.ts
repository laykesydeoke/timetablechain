export function validatesluggenValue(val: number): { valid: boolean; error?: string } {
...
export function validatesluggenId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatsluggenValue(val: number): string {
