export function validatevaultsvcValue(val: number): { valid: boolean; error?: string } {
...
export function validatevaultsvcId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatvaultsvcValue(val: number): string {
