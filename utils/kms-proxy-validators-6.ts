export function validatekmsproxyValue(val: number): { valid: boolean; error?: string } {
...
export function validatekmsproxyId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatkmsproxyValue(val: number): string {
