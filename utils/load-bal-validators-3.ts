export function validateloadbalValue(val: number): { valid: boolean; error?: string } {
...
export function validateloadbalId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatloadbalValue(val: number): string {
