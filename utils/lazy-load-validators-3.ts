export function validatelazyloadValue(val: number): { valid: boolean; error?: string } {
...
export function validatelazyloadId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatlazyloadValue(val: number): string {
