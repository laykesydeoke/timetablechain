export function validateeventsysValue(val: number): { valid: boolean; error?: string } {
...
export function validateeventsysId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formateventsysValue(val: number): string {
