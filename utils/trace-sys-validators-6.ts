export function validatetracesysValue(val: number): { valid: boolean; error?: string } {
...
export function validatetracesysId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formattracesysValue(val: number): string {
