export function validatefailoverValue(val: number): { valid: boolean; error?: string } {
...
export function validatefailoverId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatfailoverValue(val: number): string {
