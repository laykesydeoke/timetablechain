export function validaterbacctrlValue(val: number): { valid: boolean; error?: string } {
...
export function validaterbacctrlId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatrbacctrlValue(val: number): string {
