export function validatepurgejobValue(val: number): { valid: boolean; error?: string } {
...
export function validatepurgejobId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatpurgejobValue(val: number): string {
