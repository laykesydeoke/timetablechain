export function validatecachingValue(val: number): { valid: boolean; error?: string } {
...
export function validatecachingId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatcachingValue(val: number): string {
