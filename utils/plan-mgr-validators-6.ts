export function validateplanmgrValue(val: number): { valid: boolean; error?: string } {
...
export function validateplanmgrId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatplanmgrValue(val: number): string {
