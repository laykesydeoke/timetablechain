export function validateseeddataValue(val: number): { valid: boolean; error?: string } {
...
export function validateseeddataId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatseeddataValue(val: number): string {
