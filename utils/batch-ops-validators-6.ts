export function validatebatchopsValue(val: number): { valid: boolean; error?: string } {
...
export function validatebatchopsId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatbatchopsValue(val: number): string {
