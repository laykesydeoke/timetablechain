export function validatebuildoptValue(val: number): { valid: boolean; error?: string } {
...
export function validatebuildoptId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatbuildoptValue(val: number): string {
