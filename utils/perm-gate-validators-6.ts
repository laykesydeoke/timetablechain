export function validatepermgateValue(val: number): { valid: boolean; error?: string } {
...
export function validatepermgateId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatpermgateValue(val: number): string {
