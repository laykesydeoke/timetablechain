export function validateapigwValue(val: number): { valid: boolean; error?: string } {
...
export function validateapigwId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatapigwValue(val: number): string {
