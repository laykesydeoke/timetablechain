export function validatel10nmgrValue(val: number): { valid: boolean; error?: string } {
...
export function validatel10nmgrId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formatl10nmgrValue(val: number): string {
