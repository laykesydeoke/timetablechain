export function validatei18nsvcValue(val: number): { valid: boolean; error?: string } {
...
export function validatei18nsvcId(id: number): boolean {
  return Number.isInteger(id) && id > 0;
}
export function formati18nsvcValue(val: number): string {
