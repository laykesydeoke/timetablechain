...
interface complianceEntry { id: number; value: number; active: boolean; owner: string; }
...
export default function complianceList() {
  ...
  if (loading) return <div className="animate-pulse">Loading compliance entries...</div>;

  return (
    <div className="space-y-2">
      <h2 className="text-xl font-bold">compliance Registry</h2>
      {entries.length === 0 ? (
