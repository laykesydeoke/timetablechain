...
interface analyticsEntry { id: number; value: number; active: boolean; owner: string; }
...
export default function analyticsList() {
  ...
  if (loading) return <div className="animate-pulse">Loading analytics entries...</div>;

  return (
    <div className="space-y-2">
      <h2 className="text-xl font-bold">analytics Registry</h2>
      {entries.length === 0 ? (
