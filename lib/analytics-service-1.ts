import { analytics_CONFIG } from '../utils/analytics-constants-1';

export class analyticsService1 {
  private contractName: string;
  constructor(contractName = analytics_CONFIG.contractName) { this.contractName = contractName; }
