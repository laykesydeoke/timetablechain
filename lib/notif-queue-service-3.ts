import { notif_queue_CONFIG } from '../utils/notif-queue-constants-1';

export class notifqueueService3 {
  private contractName: string;
  constructor(contractName = notif_queue_CONFIG.contractName) { this.contractName = contractName; }
