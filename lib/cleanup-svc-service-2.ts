import { cleanup_svc_CONFIG } from '../utils/cleanup-svc-constants-1';

export class cleanupsvcService2 {
  private contractName: string;
  constructor(contractName = cleanup_svc_CONFIG.contractName) { this.contractName = contractName; }
