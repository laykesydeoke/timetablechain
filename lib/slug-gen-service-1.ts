import { slug_gen_CONFIG } from '../utils/slug-gen-constants-1';

export class sluggenService1 {
  private contractName: string;
  constructor(contractName = slug_gen_CONFIG.contractName) { this.contractName = contractName; }
