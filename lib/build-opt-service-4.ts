import { build_opt_CONFIG } from '../utils/build-opt-constants-1';

export class buildoptService4 {
  private contractName: string;
  constructor(contractName = build_opt_CONFIG.contractName) { this.contractName = contractName; }
