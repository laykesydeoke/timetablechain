import { xss_guard_CONFIG } from '../utils/xss-guard-constants-1';

export class xssguardService3 {
  private contractName: string;
  constructor(contractName = xss_guard_CONFIG.contractName) { this.contractName = contractName; }
