import { asset_pipe_CONFIG } from '../utils/asset-pipe-constants-1';

export class assetpipeService2 {
  private contractName: string;
  constructor(contractName = asset_pipe_CONFIG.contractName) { this.contractName = contractName; }
