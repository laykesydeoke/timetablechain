import { batch_ops_CONFIG } from '../utils/batch-ops-constants-1';

export class batchopsService4 {
  private contractName: string;
  constructor(contractName = batch_ops_CONFIG.contractName) { this.contractName = contractName; }
