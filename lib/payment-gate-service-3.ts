import { payment_gate_CONFIG } from '../utils/payment-gate-constants-1';

export class paymentgateService3 {
  private contractName: string;
  constructor(contractName = payment_gate_CONFIG.contractName) { this.contractName = contractName; }
