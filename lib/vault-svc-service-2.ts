import { vault_svc_CONFIG } from '../utils/vault-svc-constants-1';

export class vaultsvcService2 {
  private contractName: string;
  constructor(contractName = vault_svc_CONFIG.contractName) { this.contractName = contractName; }
