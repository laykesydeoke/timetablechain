import { secret_mgr_CONFIG } from '../utils/secret-mgr-constants-1';

export class secretmgrService2 {
  private contractName: string;
  constructor(contractName = secret_mgr_CONFIG.contractName) { this.contractName = contractName; }
