import { log_rotate_CONFIG } from '../utils/log-rotate-constants-1';

export class logrotateService4 {
  private contractName: string;
  constructor(contractName = log_rotate_CONFIG.contractName) { this.contractName = contractName; }
