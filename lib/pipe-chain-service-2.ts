import { pipe_chain_CONFIG } from '../utils/pipe-chain-constants-1';

export class pipechainService2 {
  private contractName: string;
  constructor(contractName = pipe_chain_CONFIG.contractName) { this.contractName = contractName; }
