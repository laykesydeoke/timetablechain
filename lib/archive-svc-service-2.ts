import { archive_svc_CONFIG } from '../utils/archive-svc-constants-1';

export class archivesvcService2 {
  private contractName: string;
  constructor(contractName = archive_svc_CONFIG.contractName) { this.contractName = contractName; }
