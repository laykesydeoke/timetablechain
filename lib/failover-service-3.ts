import { failover_CONFIG } from '../utils/failover-constants-1';

export class failoverService3 {
  private contractName: string;
  constructor(contractName = failover_CONFIG.contractName) { this.contractName = contractName; }
