import { timezone_svc_CONFIG } from '../utils/timezone-svc-constants-1';

export class timezonesvcService1 {
  private contractName: string;
  constructor(contractName = timezone_svc_CONFIG.contractName) { this.contractName = contractName; }
