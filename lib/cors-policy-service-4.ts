import { cors_policy_CONFIG } from '../utils/cors-policy-constants-1';

export class corspolicyService4 {
  private contractName: string;
  constructor(contractName = cors_policy_CONFIG.contractName) { this.contractName = contractName; }
