import { event_sys_CONFIG } from '../utils/event-sys-constants-1';

export class eventsysService3 {
  private contractName: string;
  constructor(contractName = event_sys_CONFIG.contractName) { this.contractName = contractName; }
