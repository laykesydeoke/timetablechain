import { url_encode_CONFIG } from '../utils/url-encode-constants-1';

export class urlencodeService1 {
  private contractName: string;
  constructor(contractName = url_encode_CONFIG.contractName) { this.contractName = contractName; }
