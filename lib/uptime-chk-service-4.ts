import { uptime_chk_CONFIG } from '../utils/uptime-chk-constants-1';

export class uptimechkService4 {
  private contractName: string;
  constructor(contractName = uptime_chk_CONFIG.contractName) { this.contractName = contractName; }
