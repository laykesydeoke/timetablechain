import { lint_check_CONFIG } from '../utils/lint-check-constants-1';

export class lintcheckService4 {
  private contractName: string;
  constructor(contractName = lint_check_CONFIG.contractName) { this.contractName = contractName; }
