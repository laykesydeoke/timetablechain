import { span_collect_CONFIG } from '../utils/span-collect-constants-1';

export class spancollectService3 {
  private contractName: string;
  constructor(contractName = span_collect_CONFIG.contractName) { this.contractName = contractName; }
