import { dashboard_api_CONFIG } from '../utils/dashboard-api-constants-1';

export class dashboardapiService4 {
  private contractName: string;
  constructor(contractName = dashboard_api_CONFIG.contractName) { this.contractName = contractName; }
