import { webhook_mgr_CONFIG } from '../utils/webhook-mgr-constants-1';

export class webhookmgrService3 {
  private contractName: string;
  constructor(contractName = webhook_mgr_CONFIG.contractName) { this.contractName = contractName; }
