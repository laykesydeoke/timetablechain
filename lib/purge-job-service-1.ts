import { purge_job_CONFIG } from '../utils/purge-job-constants-1';

export class purgejobService1 {
  private contractName: string;
  constructor(contractName = purge_job_CONFIG.contractName) { this.contractName = contractName; }
