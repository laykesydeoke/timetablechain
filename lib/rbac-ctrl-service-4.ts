import { rbac_ctrl_CONFIG } from '../utils/rbac-ctrl-constants-1';

export class rbacctrlService4 {
  private contractName: string;
  constructor(contractName = rbac_ctrl_CONFIG.contractName) { this.contractName = contractName; }
