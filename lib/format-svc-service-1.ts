import { format_svc_CONFIG } from '../utils/format-svc-constants-1';

export class formatsvcService1 {
  private contractName: string;
  constructor(contractName = format_svc_CONFIG.contractName) { this.contractName = contractName; }
