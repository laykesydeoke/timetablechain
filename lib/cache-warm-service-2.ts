import { cache_warm_CONFIG } from '../utils/cache-warm-constants-1';

export class cachewarmService2 {
  private contractName: string;
  constructor(contractName = cache_warm_CONFIG.contractName) { this.contractName = contractName; }
