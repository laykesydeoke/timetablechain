import { usage_alert_CONFIG } from '../utils/usage-alert-constants-1';

export class usagealertService3 {
  private contractName: string;
  constructor(contractName = usage_alert_CONFIG.contractName) { this.contractName = contractName; }
