import { latency_mon_CONFIG } from '../utils/latency-mon-constants-1';

export class latencymonService1 {
  private contractName: string;
  constructor(contractName = latency_mon_CONFIG.contractName) { this.contractName = contractName; }
