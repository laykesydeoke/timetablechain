import { backup_svc_CONFIG } from '../utils/backup-svc-constants-1';

export class backupsvcService4 {
  private contractName: string;
  constructor(contractName = backup_svc_CONFIG.contractName) { this.contractName = contractName; }
