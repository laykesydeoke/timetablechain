import { access_ctrl_CONFIG } from '../utils/access-ctrl-constants-1';

export class accessctrlService2 {
  private contractName: string;
  constructor(contractName = access_ctrl_CONFIG.contractName) { this.contractName = contractName; }
