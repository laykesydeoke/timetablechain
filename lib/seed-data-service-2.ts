import { seed_data_CONFIG } from '../utils/seed-data-constants-1';

export class seeddataService2 {
  private contractName: string;
  constructor(contractName = seed_data_CONFIG.contractName) { this.contractName = contractName; }
