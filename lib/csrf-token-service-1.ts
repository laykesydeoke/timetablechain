import { csrf_token_CONFIG } from '../utils/csrf-token-constants-1';

export class csrftokenService1 {
  private contractName: string;
  constructor(contractName = csrf_token_CONFIG.contractName) { this.contractName = contractName; }
