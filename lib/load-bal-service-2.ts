import { load_bal_CONFIG } from '../utils/load-bal-constants-1';

export class loadbalService2 {
  private contractName: string;
  constructor(contractName = load_bal_CONFIG.contractName) { this.contractName = contractName; }
