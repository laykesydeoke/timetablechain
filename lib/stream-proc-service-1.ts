import { stream_proc_CONFIG } from '../utils/stream-proc-constants-1';

export class streamprocService1 {
  private contractName: string;
  constructor(contractName = stream_proc_CONFIG.contractName) { this.contractName = contractName; }
