import { pagination_CONFIG } from '../utils/pagination-constants-1';

export class paginationService1 {
  private contractName: string;
  constructor(contractName = pagination_CONFIG.contractName) { this.contractName = contractName; }
