import { timeout_mgr_CONFIG } from '../utils/timeout-mgr-constants-1';

export class timeoutmgrService1 {
  private contractName: string;
  constructor(contractName = timeout_mgr_CONFIG.contractName) { this.contractName = contractName; }
