import { token_auth_CONFIG } from '../utils/token-auth-constants-1';

export class tokenauthService4 {
  private contractName: string;
  constructor(contractName = token_auth_CONFIG.contractName) { this.contractName = contractName; }
