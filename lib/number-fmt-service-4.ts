import { number_fmt_CONFIG } from '../utils/number-fmt-constants-1';

export class numberfmtService4 {
  private contractName: string;
  constructor(contractName = number_fmt_CONFIG.contractName) { this.contractName = contractName; }
