import { lazy_load_CONFIG } from '../utils/lazy-load-constants-1';

export class lazyloadService2 {
  private contractName: string;
  constructor(contractName = lazy_load_CONFIG.contractName) { this.contractName = contractName; }
