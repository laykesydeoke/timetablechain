import { plan_mgr_CONFIG } from '../utils/plan-mgr-constants-1';

export class planmgrService3 {
  private contractName: string;
  constructor(contractName = plan_mgr_CONFIG.contractName) { this.contractName = contractName; }
