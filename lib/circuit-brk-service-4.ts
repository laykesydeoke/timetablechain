import { circuit_brk_CONFIG } from '../utils/circuit-brk-constants-1';

export class circuitbrkService4 {
  private contractName: string;
  constructor(contractName = circuit_brk_CONFIG.contractName) { this.contractName = contractName; }
