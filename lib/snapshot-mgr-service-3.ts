import { snapshot_mgr_CONFIG } from '../utils/snapshot-mgr-constants-1';

export class snapshotmgrService3 {
  private contractName: string;
  constructor(contractName = snapshot_mgr_CONFIG.contractName) { this.contractName = contractName; }
