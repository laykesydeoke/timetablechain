import { invoice_gen_CONFIG } from '../utils/invoice-gen-constants-1';

export class invoicegenService2 {
  private contractName: string;
  constructor(contractName = invoice_gen_CONFIG.contractName) { this.contractName = contractName; }
