import { alert_rule_CONFIG } from '../utils/alert-rule-constants-1';

export class alertruleService1 {
  private contractName: string;
  constructor(contractName = alert_rule_CONFIG.contractName) { this.contractName = contractName; }
