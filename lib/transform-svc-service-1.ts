import { transform_svc_CONFIG } from '../utils/transform-svc-constants-1';

export class transformsvcService1 {
  private contractName: string;
  constructor(contractName = transform_svc_CONFIG.contractName) { this.contractName = contractName; }
