import { perm_gate_CONFIG } from '../utils/perm-gate-constants-1';

export class permgateService2 {
  private contractName: string;
  constructor(contractName = perm_gate_CONFIG.contractName) { this.contractName = contractName; }
