import { cdn_config_CONFIG } from '../utils/cdn-config-constants-1';

export class cdnconfigService4 {
  private contractName: string;
  constructor(contractName = cdn_config_CONFIG.contractName) { this.contractName = contractName; }
