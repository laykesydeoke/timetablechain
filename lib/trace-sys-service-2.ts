import { trace_sys_CONFIG } from '../utils/trace-sys-constants-1';

export class tracesysService2 {
  private contractName: string;
  constructor(contractName = trace_sys_CONFIG.contractName) { this.contractName = contractName; }
