import { acl_engine_CONFIG } from '../utils/acl-engine-constants-1';

export class aclengineService2 {
  private contractName: string;
  constructor(contractName = acl_engine_CONFIG.contractName) { this.contractName = contractName; }
