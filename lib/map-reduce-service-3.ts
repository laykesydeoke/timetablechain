import { map_reduce_CONFIG } from '../utils/map-reduce-constants-1';

export class mapreduceService3 {
  private contractName: string;
  constructor(contractName = map_reduce_CONFIG.contractName) { this.contractName = contractName; }
