import { bundle_svc_CONFIG } from '../utils/bundle-svc-constants-1';

export class bundlesvcService2 {
  private contractName: string;
  constructor(contractName = bundle_svc_CONFIG.contractName) { this.contractName = contractName; }
