import { refund_proc_CONFIG } from '../utils/refund-proc-constants-1';

export class refundprocService4 {
  private contractName: string;
  constructor(contractName = refund_proc_CONFIG.contractName) { this.contractName = contractName; }
