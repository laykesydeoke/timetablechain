import { cert_mgr_CONFIG } from '../utils/cert-mgr-constants-1';

export class certmgrService2 {
  private contractName: string;
  constructor(contractName = cert_mgr_CONFIG.contractName) { this.contractName = contractName; }
