import { schema_mig_CONFIG } from '../utils/schema-mig-constants-1';

export class schemamigService2 {
  private contractName: string;
  constructor(contractName = schema_mig_CONFIG.contractName) { this.contractName = contractName; }
