import { eager_fetch_CONFIG } from '../utils/eager-fetch-constants-1';

export class eagerfetchService4 {
  private contractName: string;
  constructor(contractName = eager_fetch_CONFIG.contractName) { this.contractName = contractName; }
