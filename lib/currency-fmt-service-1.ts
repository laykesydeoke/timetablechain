import { currency_fmt_CONFIG } from '../utils/currency-fmt-constants-1';

export class currencyfmtService1 {
  private contractName: string;
  constructor(contractName = currency_fmt_CONFIG.contractName) { this.contractName = contractName; }
