import { validate_ci_CONFIG } from '../utils/validate-ci-constants-1';

export class validateciService2 {
  private contractName: string;
  constructor(contractName = validate_ci_CONFIG.contractName) { this.contractName = contractName; }
