import { l10n_mgr_CONFIG } from '../utils/l10n-mgr-constants-1';

export class l10nmgrService3 {
  private contractName: string;
  constructor(contractName = l10n_mgr_CONFIG.contractName) { this.contractName = contractName; }
