import { report_gen_CONFIG } from '../utils/report-gen-constants-1';

export class reportgenService3 {
  private contractName: string;
  constructor(contractName = report_gen_CONFIG.contractName) { this.contractName = contractName; }
