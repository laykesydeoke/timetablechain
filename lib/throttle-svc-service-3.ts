import { throttle_svc_CONFIG } from '../utils/throttle-svc-constants-1';

export class throttlesvcService3 {
  private contractName: string;
  constructor(contractName = throttle_svc_CONFIG.contractName) { this.contractName = contractName; }
