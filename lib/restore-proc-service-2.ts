import { restore_proc_CONFIG } from '../utils/restore-proc-constants-1';

export class restoreprocService2 {
  private contractName: string;
  constructor(contractName = restore_proc_CONFIG.contractName) { this.contractName = contractName; }
