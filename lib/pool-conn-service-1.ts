import { pool_conn_CONFIG } from '../utils/pool-conn-constants-1';

export class poolconnService1 {
  private contractName: string;
  constructor(contractName = pool_conn_CONFIG.contractName) { this.contractName = contractName; }
