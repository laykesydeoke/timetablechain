import { compliance_CONFIG } from '../utils/compliance-constants-1';

export class complianceService1 {
  private contractName: string;
  constructor(contractName = compliance_CONFIG.contractName) { this.contractName = contractName; }
