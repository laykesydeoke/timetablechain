import { kms_proxy_CONFIG } from '../utils/kms-proxy-constants-1';

export class kmsproxyService4 {
  private contractName: string;
  constructor(contractName = kms_proxy_CONFIG.contractName) { this.contractName = contractName; }
