import { filter_eng_CONFIG } from '../utils/filter-eng-constants-1';

export class filterengService2 {
  private contractName: string;
  constructor(contractName = filter_eng_CONFIG.contractName) { this.contractName = contractName; }
