import { compact_svc_CONFIG } from '../utils/compact-svc-constants-1';

export class compactsvcService3 {
  private contractName: string;
  constructor(contractName = compact_svc_CONFIG.contractName) { this.contractName = contractName; }
