import { gc_runner_CONFIG } from '../utils/gc-runner-constants-1';

export class gcrunnerService3 {
  private contractName: string;
  constructor(contractName = gc_runner_CONFIG.contractName) { this.contractName = contractName; }
