import { carrier_api_CONFIG } from '../utils/carrier-api-constants-1';

export class carrierapiService4 {
  private contractName: string;
  constructor(contractName = carrier_api_CONFIG.contractName) { this.contractName = contractName; }
