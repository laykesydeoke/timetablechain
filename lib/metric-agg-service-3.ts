import { metric_agg_CONFIG } from '../utils/metric-agg-constants-1';

export class metricaggService3 {
  private contractName: string;
  constructor(contractName = metric_agg_CONFIG.contractName) { this.contractName = contractName; }
