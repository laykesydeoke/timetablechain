import { deploy_hook_CONFIG } from '../utils/deploy-hook-constants-1';

export class deployhookService3 {
  private contractName: string;
  constructor(contractName = deploy_hook_CONFIG.contractName) { this.contractName = contractName; }
