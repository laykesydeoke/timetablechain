import { session_mgr_CONFIG } from '../utils/session-mgr-constants-1';

export class sessionmgrService4 {
  private contractName: string;
  constructor(contractName = session_mgr_CONFIG.contractName) { this.contractName = contractName; }
