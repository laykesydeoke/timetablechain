import { test_runner_CONFIG } from '../utils/test-runner-constants-1';

export class testrunnerService3 {
  private contractName: string;
  constructor(contractName = test_runner_CONFIG.contractName) { this.contractName = contractName; }
