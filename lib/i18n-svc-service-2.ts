import { i18n_svc_CONFIG } from '../utils/i18n-svc-constants-1';

export class i18nsvcService2 {
  private contractName: string;
  constructor(contractName = i18n_svc_CONFIG.contractName) { this.contractName = contractName; }
