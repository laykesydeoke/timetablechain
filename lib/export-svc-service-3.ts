import { export_svc_CONFIG } from '../utils/export-svc-constants-1';

export class exportsvcService3 {
  private contractName: string;
  constructor(contractName = export_svc_CONFIG.contractName) { this.contractName = contractName; }
