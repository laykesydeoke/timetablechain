import { rate_limit_CONFIG } from '../utils/rate-limit-constants-1';

export class ratelimitService4 {
  private contractName: string;
  constructor(contractName = rate_limit_CONFIG.contractName) { this.contractName = contractName; }
