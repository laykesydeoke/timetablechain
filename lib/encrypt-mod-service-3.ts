import { encrypt_mod_CONFIG } from '../utils/encrypt-mod-constants-1';

export class encryptmodService3 {
  private contractName: string;
  constructor(contractName = encrypt_mod_CONFIG.contractName) { this.contractName = contractName; }
