import { env_config_CONFIG } from '../utils/env-config-constants-1';

export class envconfigService2 {
  private contractName: string;
  constructor(contractName = env_config_CONFIG.contractName) { this.contractName = contractName; }
