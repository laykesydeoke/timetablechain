import { csp_header_CONFIG } from '../utils/csp-header-constants-1';

export class cspheaderService4 {
  private contractName: string;
  constructor(contractName = csp_header_CONFIG.contractName) { this.contractName = contractName; }
