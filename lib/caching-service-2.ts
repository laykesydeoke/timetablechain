import { caching_CONFIG } from '../utils/caching-constants-1';

export class cachingService2 {
  private contractName: string;
  constructor(contractName = caching_CONFIG.contractName) { this.contractName = contractName; }
